...
# Gapcheck muss unbedingt über die Jobs iterieren, nicht über maschinen oder works!
# ansonsten kann ein job aufgrund seines parents nicht nach vorne gebracht werden
    ...
    for m in schedule.machines:
        for mw in m.work:
            ...
            if workbefore.idle and mw.parent.start_time + mw.parent.time <= mw.start_time - mw.time and mw.time <= workbefore.time:
                ...
                if gapstep:  # also wenn er nicht none ist
